...
ACC, PACC, OQT, and ARC. Therefore, for OQT and ARC we decided to fix the proportion of the hold-out split to 1/3 and do not include this hyperparameter in the exploration, since those methods are computationally expensive.% save computational resources by omitting some values of this parameter in the final hyperparameter grid.
